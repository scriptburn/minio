...
func TestTraceHTTPHandler(t *testing.T) {
	...
	testCases := []struct {
...

		{
			...
			expectedLogRegexp: `\[REQUEST github.com/scriptburn/minio/pkg/handlers.wsTestSuccessHandler\] \[[^\]]*\] \[[^\]]*\]
PUT /test-log
Host:\ 
...
`,
		},
		{
			...
			expectedLogRegexp: `\[REQUEST github.com/scriptburn/minio/pkg/handlers.wsTest404Handler\] \[[^\]]*\] \[[^\]]*\]
POST /test-log
Host:\ 
Test-Header: TestHeaderValue
