...
go get -u github.com/scriptburn/minio/pkg/madmin
...
* [service-status.go](https://github.com/scriptburn/minio/blob/master/pkg/madmin/examples/service-status.go)
* [service-restart.go](https://github.com/scriptburn/minio/blob/master/pkg/madmin/examples/service-restart.go)
* [set-credentials.go](https://github.com/scriptburn/minio/blob/master/pkg/madmin/examples/set-credentials.go)

## Contribute

[Contributors Guide](https://github.com/scriptburn/minio/blob/master/CONTRIBUTING.md)
