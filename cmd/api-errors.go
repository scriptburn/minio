...
const (
	...
	ErrBackendDown
	// Add new extended error codes here.
	// Please open a https://github.com/scriptburn/minio/issues before adding
...
var errorCodeResponse = map[APIErrorCode]APIError{
	...
	// FIXME: Should contain the invalid param set as seen in https://github.com/scriptburn/minio/issues/2385.
