...
Fork [Minio upstream](https://github.com/scriptburn/minio/fork) source repository to your own personal repository. Copy the URL of your Minio fork (you will need it for the `git clone` command below).
