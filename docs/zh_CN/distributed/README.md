...
分布式Minio采用 [erasure code](https://docs.minio.io/cn/minio-erasure-code-quickstart-guide)来防范多个节点宕机和[位衰减`bit rot`](https://github.com/scriptburn/minio/blob/master/docs/zh_CN/erasure/README.md#what-is-bit-rot-protection)。  
...
![分布式Minio,8节点，每个节点一块盘](https://github.com/scriptburn/minio/blob/master/docs/screenshots/Architecture-diagram_distributed_8.jpg?raw=true)
...
![分布式Minio,4节点，每节点4块盘](https://github.com/scriptburn/minio/blob/master/docs/screenshots/Architecture-diagram_distributed_16.jpg?raw=true)
