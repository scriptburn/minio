...
- 你也可以浏览Kubernetes [Minio示例](https://github.com/scriptburn/minio/blob/master/docs/orchestration/kubernetes/README.md) ，通过`.yaml`文件来部署Minio。
...
如需采用[shared mode](https://github.com/scriptburn/minio/blob/master/docs/shared-backend/README.md)部署Minio, 将`mode` 设为`shared`,
