...
Storage class can also be set via `mc admin config` get/set commands to update the configuration. Refer [storage class](https://github.com/scriptburn/minio/tree/master/docs/config#storage-class) for
more details.
