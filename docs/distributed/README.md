...
You can also use [storage classes](https://github.com/scriptburn/minio/tree/master/docs/erasure/storage-class) to set custom data and parity distribution across total disks.
...
![Distributed Minio, 8 nodes with 1 disk each](https://github.com/scriptburn/minio/blob/master/docs/screenshots/Architecture-diagram_distributed_8.jpg?raw=true)
#### GNU/Linux and macOS
