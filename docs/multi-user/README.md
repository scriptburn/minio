...
- Configure etcd (optional needed only in gateway or federation mode) - [Etcd V3 Quickstart Guide](https://github.com/scriptburn/minio/blob/master/docs/sts/etcd.md)
