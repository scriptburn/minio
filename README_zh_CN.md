...
![Screenshot](https://github.com/scriptburn/minio/blob/master/docs/screenshots/minio-browser.png?raw=true)
...
## 如何参与到Minio项目
请参考 [贡献者指南](https://github.com/scriptburn/minio/blob/master/CONTRIBUTING.md)。欢迎各位中国程序员加到Minio项目中。
